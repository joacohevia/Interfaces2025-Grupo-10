...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupPasswordToggle(toggleBtn, passwordField) {
        toggleBtn.addEventListener('click', function(e) {
            ...
            icon.src = isPassword ? '../assets/img/eyes-on.png' : '../assets/img/eyes-off.png';
        });
    }
    ...
    togglePasswordConfirm.addEventListener('click', function(e) {
        ...
        // Cambiar el icono del ojo (intercambiado para corregir la lógica)
        const imgSrc = type === 'password' ? '../assets/img/eyes-on.png' : '../assets/img/eyes-off.png';
