...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateCarousel() {
        ...
        console.log(`🎠 Actualizando carrusel - Slide ${currentIndex + 1}/${totalItems}`);
        
        isTransitioning = true;
        const newTransform = -currentIndex * 100 + '%';
        track.style.transform = `translateX(${newTransform})`;
        
        console.log(`🔄 Transform aplicado: ${newTransform}`);
    ...
    function startAutoplay() {
        console.log('▶️ Iniciando autoplay del carrusel');
        autoplayInterval = setInterval(() => {
            if (!isPaused) {
                console.log('⏭️ Autoplay - avanzando slide');
                currentIndex = (currentIndex + 1) % totalItems;
                updateCarousel();
            } else {
    ...
    // Iniciar el carrusel
    console.log('🚀 Iniciando carrusel por primera vez');
    updateCarousel();
    startAutoplay();
