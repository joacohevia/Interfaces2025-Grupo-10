...
export class FlappyController {
    constructor() {
        ...
        if (!this.canvas) console.error("¡ERROR! No se encontró el elemento <canvas id='gameCanvas'> en el HTML.");
        
        // Instanciar MVC
        this.modeloLaser = new modeloLaser();
        this.vistaLaser = new vistaLaser(this.canvas, this.modeloLaser);
