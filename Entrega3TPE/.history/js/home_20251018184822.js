...
function setupBurgerMenuNavigation() {
    ...
    const categoryMap = {
        'Acción': 'section-logicGames',
        'Aventura': 'section-suggestedGames',
        'Carreras': 'section-suggestedGames',
        'Clásicos': 'section-classicGames',
        'Cocina': 'section-suggestedGames',
        'Deportes': 'section-suggestedGames',
        'Escape': 'section-suggestedGames',
        'Estrategia': 'section-strategyGames',
        'Guerra': 'section-suggestedGames',
        'Habilidad': 'section-suggestedGames',
        'Infantiles': 'section-suggestedGames',
        'Multijugador': 'section-multiplayerGames',
        'Plataformas': 'section-suggestedGames',
        'Puzzle': 'section-logicGames',
        'Terror': 'section-suggestedGames'
    };
