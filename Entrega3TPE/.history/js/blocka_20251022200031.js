...
function initGameLevel() {
  ...
  let gameDisplayContainer = document.getElementById('game-board-display');
...
function startThumbnailSelection(subdivisions) {
  ...
  // Solo reiniciar el índice si es la primera vez que se selecciona subdivisión
  if (typeof indiceNivelActual === 'undefined' || indiceNivelActual === null) {
    indiceNivelActual = 0;
  }
