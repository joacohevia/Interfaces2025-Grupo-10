...
function showStartButton() {
  ...
  // Restaurar el background al valor por defecto
  gameDisplayContainer.style.background = '';
  // Mostrar los botones de compartir y expandir si existen
  const overlayBtns = document.getElementById('blocka-overlay-btns');
  if (overlayBtns) {
  ...
  startBtn.onclick = () => {
    ...
    // Ocultar los botones de compartir y expandir al iniciar el juego
    const overlayBtns = document.getElementById('blocka-overlay-btns');
    if (overlayBtns) {
