...
class FlappyController {
    ...
    loop() {
        ...
        const colisionMeteorito = this.modeloMeteorito.verificarColision(
                astronautaData.x, 
                astronautaData.y, 
                astronautaData.ancho, 
                astronautaData.alto
        ...
        const colisionEstrella = this.modeloEstrella.verificarColisionEstrella(
                astronautaData.x,
                astronautaData.y,
                astronautaData.ancho,
                astronautaData.alto
        ...
        if (colisionEstrella) {
            console.log("Colision Estrella! + 5 puntos");
    ...
    ganar() {
        ...
        // Opcional: Sonido de victoria si tienes
    }
