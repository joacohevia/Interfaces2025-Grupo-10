...
function seleccionarOpcion(opcion) {
    switch (opcion) {
        case 1:
            sharedImg.src = 'assets/imgPeg/test6.jpg';
            break;
        case 2:
            sharedImg.src = 'assets/imgPeg/test7.jpg';
            break;
        case 3:
            sharedImg.src = 'assets/imgPeg/test8.jpg';
            break;
    };
...
function actualizarCronometro() {
  ...
  const transcurrido = Date.now() - timerStart;
   const restante = Math.max(0, TIEMPO_LIMITE_MS - transcurrido);
