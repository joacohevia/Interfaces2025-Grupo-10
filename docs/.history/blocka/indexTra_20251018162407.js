...
lienzo.addEventListener('mousedown', (e) => {
  ...
  // Solo iniciar si no se perdió por tiempo máximo y no se ha ganado el nivel
  if (!juegoEnCurso && btnGameControl && !btnGameControl.disabled && tiempoMaximo !== 0 && contadorCorrectas !== piezas.length) {
    detenerTemporizador();
    tiempoInicio = Date.now();
    iniciarTemporizador();
    btnGameControl.textContent = 'Reiniciar';
